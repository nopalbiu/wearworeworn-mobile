...
<head>
    ...
    <title>Log In - WearWoreWorn</title>
    ...
    <nav class="bg-zinc-950/80 backdrop-blur-md border-b border-zinc-800/60 p-4 sticky top-0 z-50 shadow-sm relative">
        <div class="container mx-auto flex justify-between items-center relative">
            ...
            <div class="flex items-center space-x-6 relative z-10">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-zinc-100 hover:text-blue-400 text-sm font-semibold transition-colors drop-shadow-[0_0_8px_rgba(96,165,250,0.3)]">Log In</a>
    ...
    <main class="flex-grow flex items-center justify-center p-4 relative z-10 mt-10 mb-10">
        ...
        <div class="relative w-full max-w-md">
            <div class="bg-zinc-900/40 p-8 sm:p-10 rounded-2xl shadow-2xl border border-zinc-800/80 backdrop-blur-md">
                ...
                <h1 class="text-3xl font-extrabold text-center mb-8 text-white tracking-tight">Log In</h1>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div class="text-center pt-2">
                        <p class="text-zinc-500 text-sm">Don't have an account? 
                            <a href="{{ route('register') }}" class="text-zinc-300 hover:text-white font-semibold transition-colors underline underline-offset-4 decoration-zinc-700 hover:decoration-white">Sign Up</a>
                        </p>
                    </div>
